window.addEventListener('input', function (e) {
 ...
 final_url_field.value = "https://kiranpanesar.github.io/redirect-generator/go/?ios=" + window.btoa(ios_url_field.value) + "&android="+ window.btoa(android_url_field.value);
